...
#define ENABLE_VFS_SFTP 1

/* Support for SHELL vfs */
#define ENABLE_VFS_SHELL 1
...
/* Define if NCurses(w) has ESCDELAY variable */
/* #undef HAVE_ESCDELAY */
...
/* Define if ncurses library has wide characters support */
/* #undef HAVE_NCURSES_WIDECHAR */
...
/* Define NCurses library display name */
/* #undef NCURSES_LIB_DISPLAYNAME */

/* Name of package */
#define PACKAGE "mc"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "https://github.com/MidnightCommander/mc/issues"
...
/* Define to `unsigned long long int' if <sys/types.h> does not define. */
/* #undef dev_t */
