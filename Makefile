...
ACLOCAL = ${SHELL} '/data/git/rivermicro/mc/config/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/data/git/rivermicro/mc/config/missing' autoconf
AUTOHEADER = ${SHELL} '/data/git/rivermicro/mc/config/missing' autoheader
AUTOMAKE = ${SHELL} '/data/git/rivermicro/mc/config/missing' automake-1.16
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/data/git/rivermicro/mc/config/missing' makeinfo
MANDOC = -mandoc
MANIFEST_TOOL = :
...
PACKAGE_STRING = GNU Midnight Commander 84fd6ed51d2270451857b6483f2e3f49f57effa8-git
PACKAGE_TARNAME = mc
PACKAGE_URL = https://midnight-commander.org
PACKAGE_VERSION = 84fd6ed51d2270451857b6483f2e3f49f57effa8-git
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
X_PRE_LIBS = 
ZIP = /usr/bin/zip
abs_builddir = /data/git/rivermicro/mc
abs_srcdir = /data/git/rivermicro/mc
abs_top_builddir = /data/git/rivermicro/mc
abs_top_srcdir = /data/git/rivermicro/mc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /data/git/rivermicro/mc/config/install-sh
