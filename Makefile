...
ACLOCAL = ${SHELL} '/data/git/mc/config/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} '/data/git/mc/config/missing' autoconf
AUTOHEADER = ${SHELL} '/data/git/mc/config/missing' autoheader
AUTOMAKE = ${SHELL} '/data/git/mc/config/missing' automake-1.16
AWK = gawk
CC = gcc
...
EXT2FS_CFLAGS = 
EXT2FS_LIBS = 
EXTFSHELPERSDIR = /home/cris/.local/libexec/mc/extfs.d
EXTHELPERSDIR = /home/cris/.local/libexec/mc/ext.d
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/data/git/mc/config/missing' makeinfo
MANDOC = -mandoc
MANIFEST_TOOL = :
...
PACKAGE_STRING = GNU Midnight Commander a24f4688dd54f61ed1ca41180a5b7882955f8a77-git
PACKAGE_TARNAME = mc
PACKAGE_URL = https://midnight-commander.org
PACKAGE_VERSION = a24f4688dd54f61ed1ca41180a5b7882955f8a77-git
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
X_PRE_LIBS = 
ZIP = /usr/bin/zip
abs_builddir = /data/git/mc
abs_srcdir = /data/git/mc
abs_top_builddir = /data/git/mc
abs_top_srcdir = /data/git/mc
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /data/git/mc/config/install-sh
