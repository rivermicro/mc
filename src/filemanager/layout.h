...
/* If TRUE, update panel file lists dynamically on FS changes */
extern gboolean dynamic_file_list;
/* Debounce interval for dynamic updates, in seconds */
extern int dynamic_file_list_debounce_sec;
